...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Tajcoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Tajcoin
    // Mac: ~/Library/Application Support/Tajcoin
    // Unix: ~/.tajcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Tajcoin";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Tajcoin.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Tajcoind.pid"));
