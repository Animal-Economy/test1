...
{
    resize(710, 540);
    setWindowTitle(tr("Tajcoin Core") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/Tajcoin"));
    setWindowIcon(QIcon(":icons/Tajcoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Tajcoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/Tajcoin"), tr("&About Tajcoin"), this);
    aboutAction->setToolTip(tr("Show information about Tajcoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Tajcoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/Tajcoin"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/Tajcoin_testnet"));
            setWindowIcon(QIcon(":icons/Tajcoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/Tajcoin_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Tajcoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Tajcoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Tajcoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Tajcoin address or malformed URI parameters."));
    }
