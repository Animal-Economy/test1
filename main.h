...
/** Fees smaller than this (in tajshi) are considered zero fee (for transaction creation) */
static const int64_t MIN_TX_FEE = 100 * COIN;
/** Fees smaller than this (in tajshi) are considered zero fee (for relaying) */
static const int64_t MIN_RELAY_TX_FEE = MIN_TX_FEE;
/** No amount larger than this (in tajshi) is valid */
static const int64_t MAX_MONEY = 36900000 * COIN;
inline bool MoneyRange(int64_t nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
static const int64_t COIN_YEAR_REWARD = 369/100 * CENT;
...
inline int64_t FutureDriftV0(int64_t nTime, int nHeight) { return nTime + 30 * 60; }
inline int64_t FutureDrift(int64_t nTime, int nHeight) { return nTime + 30 * 60; }

inline unsigned int GetTargetSpacing(int nHeight) {return (nHeight >= 900000) ? 180 : 360; }  

/** tajcoin 1.0 */
inline bool IstajcoinV1(int nHeight) { return TestNet() || nHeight > 0; }
/** tajcoin 2.0 */
inline bool IstajcoinV2(int64_t nTime) { return TestNet() || nTime > 1509494400; }
